...
public class AppointmentDaoImpl implements AppointmentDao{
    ...
    public boolean addAppointment(Appointment a) throws SQLException {
        ...
        Instant localEndToUTCInstant = localEndZDT.toInstant();
            LocalDateTime startDateTime = localStartToUTCInstant.atZone(ZoneId.of("UTC")).toLocalDateTime();
            LocalDateTime endDateTime = localEndToUTCInstant.atZone(ZoneId.of("UTC")).toLocalDateTime();
...
//            }
    ...
    public boolean updateAppointment(Appointment a) throws SQLException {
        ...
        String sqlStatement = "UPDATE appointments " +
                ...
                "', Type = '" + a.getType() + "', Start = '" + startDateTime + "', End = '" + endDateTime + "', Last_Update = '" + utcString + "', Last_Updated_By = '" + user +
